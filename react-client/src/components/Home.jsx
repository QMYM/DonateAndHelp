...
class Home extends React.Component {
    ...
    sendMessageForMais () {
        axios.post('/serveiceSmsMais', {text: this.state.value}).then(() => {
    ...
    sendMessageForYussur () {
        axios.post('/serveiceSmsYussur', {text: this.state.value}).then(() => {
            alert('your message has been send');
            window.location.reload();
        }).catch((err) => {
            throw err;
    ...
    sendMessageForDuraidi () {
        axios.post('/serveiceSmsDuraidi', {text: this.state.value}).then(() => {
            alert('your message has been send');
            window.location.reload();
        }).catch((err) => {
            throw err;
    ...
    sendMessage () {
        axios.post('/serveiceSms', {text: this.state.value}).then(() => {
            alert('your message has been send');
            window.location.reload();
        }).catch((err) => {
            throw err;
